          ...
          <div className="w-full text-center md:block md:text-start md:w-auto">
            <div className="flex flex-col md:flex-row md:items-center md:space-x-8">
              <ul className="flex flex-col font-medium mt-4 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0">
                ...
                <li className="mb-2 md:mb-0">
                  <div className="block py-2 px-3 text-md text-black font-semibold border-2 border-transparent hover:border-gray-950 hover:rounded-lg cursor-pointer">
                    Login
                  </div>
                </li>

                <li className="mb-2 md:mb-0">
                  <div className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-3 py-2 text-center cursor-pointer">
                    Signup
                  </div>
                </li>
              </ul>
